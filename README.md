...
* If you are running on a windows machine with multiple graphics cards (ie. integrated chip + dedicated card) you can have force chrome to use either one of them via windows settings.
