...
* @returns {string}
*/
  static msm_parallel(groups: Array<any>, scalars: Array<any>): string;
/**
...
* @param {Array<any>} coeffs
*/
  static ntt_test(coeffs: Array<any>): void;
/**
* @param {bigint} degree
* @returns {Array<any>}
*/
...
export interface InitOutput {
  ...
  readonly recordciphertext_get_nonce: (a: number, b: number) => void;
  readonly recordciphertext_point_scalar_mul: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly address_to_x_coordinate: (a: number, b: number) => void;
  readonly address_from_bytes: (a: number, b: number) => number;
  readonly address_to_affine: (a: number, b: number) => void;
  readonly address_to_group: (a: number, b: number) => void;
  readonly address_add_fields: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_sub_fields: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_invert_field: (a: number, b: number, c: number) => void;
  readonly address_double_field: (a: number, b: number, c: number) => void;
  readonly address_mul_fields: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_pow_field: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_poseidon_hash: (a: number, b: number, c: number) => void;
  readonly address_sqrt: (a: number, b: number, c: number) => void;
  readonly address_add_points: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_group_scalar_mul: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly address_msm: (a: number, b: number, c: number) => void;
  readonly address_msm_parallel: (a: number, b: number, c: number) => void;
  readonly address_ntt: (a: number) => number;
  readonly address_ntt_test: (a: number) => void;
  readonly address_get_random_dense_polynomial: (a: number) => number;
  readonly address_to_string: (a: number, b: number) => void;
  readonly address_to_projective: (a: number, b: number) => void;
  ...
  readonly viewkey_to_scalar: (a: number, b: number) => void;
  readonly viewkey_view_key_ciphertext_multiply: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1847a3bf23f8114a: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h252dc7ed632c5b36: (a: number, b: number, c: number, d: number) => void;
