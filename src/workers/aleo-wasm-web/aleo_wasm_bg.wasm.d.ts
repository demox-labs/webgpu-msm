...
export function address_msm_parallel(a: number, b: number, c: number): void;
export function address_ntt(a: number): number;
export function address_ntt_test(a: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1847a3bf23f8114a(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h252dc7ed632c5b36(a: number, b: number, c: number, d: number): void;
